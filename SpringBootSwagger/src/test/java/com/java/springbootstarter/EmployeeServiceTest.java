...
public class EmployeeServiceTest {
    ...
    public void testRetieveAllEmployees(){
        EmployeeAccount newEmployee1 = new EmployeeAccount(EmployeeIDGenerator.getId(), "mota", "cincinnati", "mcc@umbc.edu", "7879-97", "MM098", 98879.0f, "Mng987", "DP09");
        EmployeeAccount newEmployee2 = new EmployeeAccount(EmployeeIDGenerator.getId(), "hehehe", "patro", "rpp@umbc.edu", "7879-97", "MM098", 98879.0f, "Mng987", "DP09");
        EmployeeAccount newEmployee3 = new EmployeeAccount(EmployeeIDGenerator.getId(), "vikram", "duffer", "cockey@umbc.edu", "7879-97", "MM098", 98879.0f, "Mng987", "DP09");
    ...
    public void testInsertNewEmployee(){
        ...
        try{
            EmployeeAccount newEmployee = new EmployeeAccount(EmployeeIDGenerator.getId(), "mota", "cincinnati", "mcc@umbc.edu", "7879-97", "MM098", 98879.0f, "Mng987", "DP09");
    ...
    public void testUpdateEmployeeByID(){
        ...
        Assert.assertEquals(updated1.getEmployeeFirstName(), "LALALA");
        Assert.assertEquals(updated2.getEmployeeFirstName(), "LALALA");
        Assert.assertEquals(updated3.getEmployeeFirstName(), "LALALA");
